...
fn store_test_balance_check() {
  ...
  let ops_old = vec![
    OpMutation {
      ...
      store: Uuid::from_str("404037f2-3db7-4dae-9884-6a79fd9cd94e").unwrap(),
      transfer: Some(Uuid::from_str("4b009d57-2a56-4e3f-8d37-d4d12fc44164").unwrap()),
      goods: Uuid::from_str("c74f7aab-bbdd-4832-8bd3-0291470e8964").unwrap(),
      batch: Batch {
      ...
      after: Some((
        InternalOperation::Issue(
          Qty::new(vec![Number {
            number: Decimal::try_from(21250).unwrap(),
            name: In(Uuid::from_str("30816a3e-1340-482d-b144-f1dd72bd69c9").unwrap(), None),
          }]),
    ...
    OpMutation {
      ...
      store: Uuid::from_str("404037f2-3db7-4dae-9884-6a79fd9cd94e").unwrap(),
      transfer: Some(Uuid::from_str("8e50d3b8-2323-47b1-8424-7d30263b1235").unwrap()),
      goods: Uuid::from_str("c74f7aab-bbdd-4832-8bd3-0291470e8964").unwrap(),
      batch: Batch {
        id: Uuid::from_str("00000000-0000-0000-0000-000000000000").unwrap(),
        date: dt("1970-01-01").unwrap(),
    ...
    OpMutation {
      ...
      store: Uuid::from_str("4b009d57-2a56-4e3f-8d37-d4d12fc44164").unwrap(),
      transfer: Some(Uuid::from_str("404037f2-3db7-4dae-9884-6a79fd9cd94e").unwrap()),
      goods: Uuid::from_str("c74f7aab-bbdd-4832-8bd3-0291470e8964").unwrap(),
      batch: Batch {
        id: Uuid::from_str("00000000-0000-0000-0000-000000000000").unwrap(),
        date: dt("1970-01-01").unwrap(),
    ...
    OpMutation {
      ...
      after: Some((
        InternalOperation::Issue(
          Qty::new(vec![Number {
            number: Decimal::try_from(8750).unwrap(),
            name: In(Uuid::from_str("30816a3e-1340-482d-b144-f1dd72bd69c9").unwrap(), None),
          }]),
          Cost::from(Decimal::try_from("0").unwrap()),
          Mode::Auto,
    ...
    OpMutation {
      ...
      store: Uuid::from_str("9afd9f8c-42cd-44e6-9d8c-2ffebf1ba061").unwrap(),
      transfer: Some(Uuid::from_str("404037f2-3db7-4dae-9884-6a79fd9cd94e").unwrap()),
      goods: Uuid::from_str("c74f7aab-bbdd-4832-8bd3-0291470e8964").unwrap(),
      batch: Batch {
        id: Uuid::from_str("00000000-0000-0000-0000-000000000000").unwrap(),
